...
mappings.put("GET:/api/restaurants/export/all", List.of("ADMIN"));
mappings.put("GET:/api/restaurants/export", List.of("ADMIN", "RESTAURANT_OWNER"));
mappings.put("POST:/api/restaurants/import", List.of("ADMIN"));
mappings.put("GET:/api/restaurants/import/template", List.of("ADMIN"));
